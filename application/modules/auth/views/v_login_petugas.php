      ...
      <div class="login-brand mb-2">
            ...
            <div class="card card-primary" style="padding-left: 10px; padding-top: 10px;">
             <img src="<?= base_url('assets/');  ?>img/e-spp.png" alt="logo" width="150">
              ...
              <form method="POST" action="<?= base_url('auth/petugas'); ?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control password" name="password" placeholder="Password" tabindex="2" required>
                    <div class="invalid-feedback">
